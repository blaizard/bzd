...
bazel run //tools/sanitizer/eslint -- "$WORKSPACE_PATH/apps/**/*.{js,vue}" --fix
bazel run //tools/sanitizer/eslint -- "$WORKSPACE_PATH/example/**/*.{js,vue}" --fix
bazel run //tools/sanitizer/eslint -- "$WORKSPACE_PATH/nodejs/**/*.{js,vue}" --fix
