...
|constexpr Metadata|[`parseMetadata(Ctx & context, bzd::StringView & format, const bzd::SizeType current)`](.)|Parse a metadata conversion string.|
...
|constexpr bool|[`contextCheck(const Ctx & context, const T & tuple)`](.)|Check the format context.|
|constexpr void|[`integer(interface::String & str, const T & n, const char *const digits)`](.)||
|constexpr void|[`fixedPoint(bzd::OStream & stream, const T & n, const SizeType maxPrecision)`](.)||
### Typedef
||||
|---:|:---|:---|
|typedef|[`Arg`](.)|alias of [`bzd::VariantConstexpr`](../../variantconstexpr/index.md)|
|typedef|[`ArgList`](.)|alias of [`bzd::impl::Vector`](../../impl/vector/index.md)|
------
