...
def configureSerial(args) -> serial.Serial:
    ...
    dataBitsMapping = {5: serial.FIVEBITS, 6: serial.SIXBITS,
                       7: serial.SEVENBITS, 8: serial.EIGHTBITS}
    parityMapping = {"none": serial.PARITY_NONE, "even": serial.PARITY_EVEN,
                     "odd": serial.PARITY_ODD, "mark": serial.PARITY_MARK, "space": serial.PARITY_SPACE}
    stopBitsMapping = {1: serial.STOPBITS_ONE,
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dev", type=str,
                        default="/dev/ttyUSB0", help="Device.")
    parser.add_argument("--baud_rate", type=int, default=115200,
                        help="Baudrate of the communication.")
    parser.add_argument("--data_bits", type=int, default=8, help="Data bits.")
    parser.add_argument(
        "--parity", choices=["none", "even", "odd", "mark", "space"], default="none", help="Parity.")
    parser.add_argument("--stop_bits", type=float,
                        default=1, help="Number of stop bits.")
    parser.add_argument("--flow_control", choices=[
                        "none", "xonxoff", "rtscts", "dsrdtr"], default="none", help="Flow control.")
