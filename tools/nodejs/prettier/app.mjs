...
(async () => {
  ...
  let promiseList = [];
  promiseList.push(evaluateFiles("babel", workspace, {
	include : [ "**.mjs", "**.cjs", "**.js" ],
  }));
  promiseList.push(evaluateFiles("vue", workspace, {
	include : [ "**.vue" ],
  }));
  promiseList.push(evaluateFiles("css", workspace, {
	include : [ "**.css" ],
  }));
  promiseList.push(evaluateFiles("scss", workspace, {
	include : [ "**.scss" ],
  }));
  promiseList.push(evaluateFiles("markdown", workspace, {
	include : [ "**.md" ],
	exclude : [ "docs/api/**" ],
  }));
