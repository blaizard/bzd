#include "tools/bdl/generators/tests/interface_custom/interface.hh"
...
TEST(Interface, Cast)
{
    ...
    static_assert(bzd::typeTraits::isSame<decltype(interface), bzd::test::MyInterface<bzd::test::Implementation>&>, "Must have the type of the interface.");
