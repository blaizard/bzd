...
load("//tools/bazel_build/rules:package.bzl", "BzdPackageFragment", "BzdPackageMetadataFragment", "bzd_package_metadata_aspect")
...
def _bzd_nodejs_web_package_impl(ctx):
    ...
    return [
        ...
        BzdPackageMetadataFragment(
            manifests = ctx.attr.build[BzdPackageMetadataFragment].manifests,
        ),
    ]
...
def _bzd_nodejs_web_exec_impl(ctx):
    ...
    return [
        ...
        BzdPackageMetadataFragment(
            manifests = ctx.attr.package[BzdPackageMetadataFragment].manifests + [ctx.file._metadata_json],
        ),
    ]
...
_bzd_nodejs_web_exec = rule(
    ...
    attrs = {
        "package": attr.label(
            #aspects = [bzd_package_metadata_aspect],
        ),
