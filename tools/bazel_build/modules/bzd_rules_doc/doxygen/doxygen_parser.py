...
class Data:
    ...
    def add(
        self, name: str, data: typing.Dict[str, typing.Any]
...
class Visitor:
    ...
    def visitParam(self, element: Element, data: Data) -> Json:
        visitors = {
            "type": lambda child, attr: {"type": child.text},
            "defname": lambda child, attr: {"name": child.text},
            "defval": lambda child, attr: {"default": child.text},
        }
