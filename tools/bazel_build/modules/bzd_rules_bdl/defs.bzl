...
bdl_library = rule(
    ...
    attrs = {
        ...
        "_bdl": attr.label(
            default = Label("@bzd_rules_bdl//python/bdl"),
            cfg = "exec",
            executable = True,
        ),
        ...
        "_deps_cc": attr.label_list(
            default = [Label("@bzd_rules_bdl//python/bdl/generators/cc/adapter:types")],
        ),
    },
    toolchains = [
...
_bdl_system = rule(
    ...
    attrs = {
        ...
        "_deps_cc": attr.label_list(
            default = [Label("@bzd_rules_bdl//python/bdl/generators/cc/adapter:context")],
        ),
    },
)
