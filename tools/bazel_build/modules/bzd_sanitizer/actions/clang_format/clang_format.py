...
def workload(
    args: typing.Tuple[pathlib.Path, pathlib.Path, bool, str, str],
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--clang-format", type=pathlib.Path, help="The path of the clang-format binary."
    )
    parser.add_argument(
        "--cc", action="store_true", help="Use clang format for C/C++ files."
    )
    parser.add_argument(
        "--js", action="store_true", help="Use clang format for Javascript files."
    )
    parser.add_argument(
        "--config",
        type=str,
