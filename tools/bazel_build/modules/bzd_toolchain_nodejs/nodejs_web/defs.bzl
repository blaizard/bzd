...
load("@bzd_toolchain_nodejs//nodejs:defs.bzl", "BzdNodeJsDepsInfo", "BzdNodeJsInstallInfo", "bzd_nodejs_aliases_symlinks", "bzd_nodejs_install")
...
_bzd_nodejs_web_build = rule(
    ...
    attrs = {
        ...
        "_webpack_config_template": attr.label(
            default = Label("@bzd_toolchain_nodejs//nodejs/metadata:webpack_config_template"),
