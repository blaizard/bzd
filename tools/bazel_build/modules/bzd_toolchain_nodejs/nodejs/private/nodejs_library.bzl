...
load("@bzd_toolchain_nodejs//nodejs:private/nodejs_install.bzl", "COMMON_ATTRS")
load("@bzd_toolchain_nodejs//nodejs:private/utils.bzl", "BzdNodeJsDepsInfo", "bzd_nodejs_make_provider", "bzd_nodejs_merge")
