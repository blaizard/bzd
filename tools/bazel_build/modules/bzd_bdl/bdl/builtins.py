...
def toLiteralSingleValue_(
    self: Builtin, args: typing.Dict[str, EntityExpression]
) -> typing.Optional[str]:
...
class AnyMeta(Builtin):
    def __init__(self) -> None:
        super().__init__(
            ...
            .setAttr("name", "Any")
            .setAttr("meta", "1")
            .addConfigValue(name="default", literal="0")
        )
...
class BindMeta(Builtin):
    def __init__(self) -> None:
        super().__init__(
            ElementBuilder("builtin")
            .setAttr("name", "bind")
            .addConfigValue(name="symbols...", symbol="Any")
            .setAttr("meta", "1")
        )
...
class String(Builtin):
    def __init__(self) -> None:
        super().__init__(
            ...
            .setAttr("name", "String")
            .addContract("string")
            .addConfigValue(name="value", literal='""')
        )
...
class Result(Builtin):
    def __init__(self) -> None:
        super().__init__(
            ElementBuilder("builtin")
            .setAttr("name", "Result")
            .addConfigType(name="Value", symbol="Any")
        )
