...
class TestRun(unittest.TestCase):
    ...
    def _clearSertializedForCompare(self, sequence: typing.List[typing.Any]) -> None:
        for element in sequence:
            for key in element.keys():
                if key == "@":
                    element["@"] = {
                        key: value["v"] for key, value in element["@"].items()
                    }
                else:
    ...
    def testUse(self) -> None:
        ...
        self.assertParserEqual(
            parser, [{"@": {"category": "use", "value": "a/normal/path.bdl"}}]
        )
    ...
    def testNamespace(self) -> None:
        ...
        self.assertParserEqual(
            parser,
            [{"@": {"category": "namespace"}, "name": [{"@": {"name": "Simple"}}]}],
        )
    ...
    def testEnum(self) -> None:
        ...
        self.assertParserEqual(
            ...
            [
                {
                    "@": {"category": "enum", "name": "MyName"},
                    "values": [{"@": {"category": "enumValue", "name": "VAL"}}],
                }
            ],
        )
            ...
            [
                {
                    "@": {"category": "enum", "name": "MyName"},
                    "values": [
                        {"@": {"category": "enumValue", "name": "VAL1"}},
                        {"@": {"category": "enumValue", "name": "VAL2"}},
                    ],
                }
            ],
        )
    ...
    def testUsing(self) -> None:
        ...
        self.assertParserEqual(
            parser,
            [{"@": {"category": "using", "name": "MyType", "symbol": "Integer"}}],
        )
        ...
        self.assertParserEqual(
            ...
            [
                {
                    "@": {"category": "using", "name": "MyType", "symbol": "Complex"},
    ...
    def testMethod(self) -> None:
        ...
        self.assertParserEqual(
            parser, [{"@": {"category": "method", "name": "simple"}, "argument": []}]
        )
        ...
        self.assertParserEqual(
            ...
            [
                {
                    "@": {"category": "method", "name": "withMultiArgs"},
                    "argument": [
                        {
                            "@": {
                                "category": "expression",
    ...
    def testExpression(self) -> None:
        ...
        self.assertParserEqual(
            ...
            [
                {
                    "@": {"category": "expression", "interface": None, "name": "var1"},
                    "fragments": [{"@": {"symbol": "Integer"}}],
                }
            ],
        )
        ...
        self.assertParserEqual(
            ...
            [
                ...
                {
                    "@": {"category": "expression", "interface": None, "name": "var2"},
                    "fragments": [{"@": {"symbol": "Integer"}}],
                },
            ],
        )
        ...
        self.assertParserEqual(
            ...
            [
                {
                    "@": {"category": "expression", "interface": None, "name": "var3"},
                    "fragments": [
                        {"@": {"symbol": "var1"}},
                        {"@": {"operator": "-"}},
                        {"@": {"symbol": "var2"}},
        ...
        self.assertParserEqual(
            ...
            [
                {
                    "@": {"category": "expression", "interface": None, "name": "reg1"},
                    "fragments": [
                        {"@": {"regexpr": "a\\..*"}},
                        {"@": {"operator": "-"}},
                        {"@": {"regexpr": "a\\.b\\..*"}},
