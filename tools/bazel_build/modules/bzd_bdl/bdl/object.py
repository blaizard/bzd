...
class ObjectContext:
    ...
    def getPreprocessedPathFromSource(self, source: str) -> Path:
        ...
        return (
            Path(split[1])
            if len(split) > 1
            else Path(self.preprocessFormat.format(source))
        )
    ...
    def preprocess(
        self, source: str, namespace: typing.Optional[typing.List[str]] = None
    ) -> "Object":
...
class Object:
    ...
    @staticmethod
    def fromContent(
        content: str, objectContext: typing.Optional[ObjectContext] = None
    ) -> "Object":
