...
class Regexpr:
    ...
    def isValid(self) -> bool:
        ...
        return self.element.isNestedSequence(
            "regexpr_include"
        ) or self.element.isNestedSequence("exclude_include")
    ...
    def addInclude(self, regexpr: str) -> None:
        ...
        ElementBuilder.cast(
            self.element, ElementBuilder
        ).pushBackElementToNestedSequence("regexpr_include", element)
    ...
    def addExclude(self, regexpr: str) -> None:
        ...
        ElementBuilder.cast(
            self.element, ElementBuilder
        ).pushBackElementToNestedSequence("regexpr_exclude", element)
    ...
    def match(
        ...
        regexprExclude = (
            re.compile("(" + "|".join(self.excludes) + ")") if self.excludes else None
        )
