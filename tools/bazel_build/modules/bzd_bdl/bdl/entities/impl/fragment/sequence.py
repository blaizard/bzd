...
class EntitySequence:
    ...
    def __init__(self, sequence: typing.List["EntityType"]) -> None:
        ...
        self.processed: typing.Optional[
            typing.Dict[Category, typing.List["EntityType"]]
        ] = None
    ...
    def expressionList(self) -> typing.List["Expression"]:
        return typing.cast(
            typing.List["Expression"], self._filteredList(Category.expression)
        )
    ...
    def namespaceList(self) -> typing.List["Namespace"]:
        return typing.cast(
            typing.List["Namespace"], self._filteredList(Category.namespace)
        )
