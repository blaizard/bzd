...
class Parent:
    def __init__(
        self, entity: typing.Optional[typing.Union[EntityType, typing.List[str]]] = None
    ) -> None:
        self.entity = entity
...
class GroupScope:
    ...
    def __exit__(
        self, exc_type: typing.Any, exc_value: typing.Any, exc_tb: typing.Any
    ) -> None:
        if self.group is not None:
            self.list.pop()
...
class Visitor(VisitorBase[T, T]):
    ...
    def __init__(
        ...
        elementToEntityExtenstion: typing.Optional[
            typing.Dict[str, typing.Type[EntityType]]
        ] = None,
    ) -> None:
    ...
    def nestedToGroup(
        self, entity: EntityType, nested: NestedSequence
    ...
    def visitElement(self, element: Element, result: T) -> T:
        ...
        entity = elementToEntity(
            element=element, extension=self.elementToEntityExtenstion
        )
            ...
            if isinstance(entity, Nested):
                ...
                for nested in NestedSequence:
                    ...
                    if sequence is not None:
                        ...
                        with self.groups.scope(
                            group=self.nestedToGroup(entity, nested)
                        ):
                            self._visit(sequence, result)
                        self.parents.pop()
