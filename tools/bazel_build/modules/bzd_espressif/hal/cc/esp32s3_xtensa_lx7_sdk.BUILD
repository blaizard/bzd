...
cc_library(
    ...
    linkopts = [
            "-L",
            "external/bzd_espressif++load_dependencies+esp32s3_xtensa_lx7_sdk/lib",
            "-mlongcalls",
            "-fno-builtin-memcpy",
            "-fno-builtin-memset",
            "-fno-builtin-bzero",
            ...
            "-fno-lto",
            "-T",
            "$(location ld/esp32s3.peripherals.ld)",
            "-T",
            "$(location ld/esp32s3.rom.ld)",
            "-T",
            "$(location ld/esp32s3.rom.api.ld)",
            "-T",
            "$(location ld/esp32s3.rom.bt_funcs.ld)",
            "-T",
            "$(location ld/esp32s3.rom.libgcc.ld)",
            "-T",
            "$(location ld/esp32s3.rom.wdt.ld)",
            "-T",
            "$(location ld/esp32s3.rom.version.ld)",
            "-T",
            "$(location ld/esp32s3.rom.newlib.ld)",
            "-T",
            ...
            "-u",
            "usb_serial_jtag_vfs_include_dev_init",
            "-u",
