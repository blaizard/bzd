...
def esp32s3_linux_x86_64(name, use_fragment):
    ...
    toolchain_definition = {
        ...
        "build_files": [
            Label("//:fragments/esp_idf/xtensa_esp_elf_14.2.0/linux_x86_64/esp32s3.BUILD"),
        ],
        "compile_flags": [
            # Allow long calls
            "-mlongcalls",
        ...
        "patches": [
            Label("//:fragments/esp_idf/xtensa_esp_elf_14.2.0/linux_x86_64/esp32s3_wrapper_cc_start_end_group.patch"),
        ],
