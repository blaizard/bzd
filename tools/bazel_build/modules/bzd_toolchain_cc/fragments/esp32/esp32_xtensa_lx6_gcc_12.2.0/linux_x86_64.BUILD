...
filegroup(
    ...
    srcs = [
        ...
        "libexec/gcc/xtensa-esp32-elf/12.2.0/*",
...
filegroup(
    ...
    srcs = [
        ...
        "libexec/gcc/xtensa-esp32-elf/12.2.0/*",
        "lib/gcc/xtensa-esp32-elf/12.2.0/*"
    ])
)
...
filegroup(
    name = "header_files",
    srcs = glob([
        "lib/gcc/xtensa-esp32-elf/12.2.0/include/**",
        "lib/gcc/xtensa-esp32-elf/12.2.0/include-fixed/**",
        "xtensa-esp32-elf/include/c++/12.2.0/xtensa-esp32-elf/**",
        "xtensa-esp32-elf/include/c++/12.2.0/**",
