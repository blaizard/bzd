...
def linux_x86_64(module_ctx, name):
    ...
    toolchain_definition = {
        ...
        "system_directories": [
            "{}/xtensa-esp-elf/include/c++/14.2.0/xtensa-esp-elf/esp32".format(repository_path),
            "{}/xtensa-esp-elf/include/c++/14.2.0/xtensa-esp32-elf".format(repository_path),
            "{}/xtensa-esp-elf/include/c++/14.2.0".format(repository_path),
            "{}/xtensa-esp-elf/include".format(repository_path),
            "{}/lib/gcc/xtensa-esp-elf/14.2.0/include".format(repository_path),
            "{}/lib/gcc/xtensa-esp-elf/14.2.0/include-fixed".format(repository_path),
        ],
        "urls": [
