...
def esp32_linux_x86_64(_module_ctx, name, _use_fragment):
    """Metadata for ESP32 toolchains.
    ...
    toolchain_definition = {
        ...
        "patches": [
            Label("//toolchains/esp_idf:xtensa_esp_elf_14.2.0/linux_x86_64/esp32_wrapper_cc_start_end_group.patch"),
        ],
