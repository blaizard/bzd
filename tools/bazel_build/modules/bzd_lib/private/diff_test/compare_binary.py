	...
	def visit(
		...
		for index1, nextIndex1, index2, nextIndex2 in self.diffs:
			...
			if delta.isEmpty:
				...
				delta.addDiff1(
					self.content1[index1 - min(index1 - previousIndex1, context) : index1],
					0,
				)
				delta.addDiff2(
					self.content2[index2 - min(index2 - previousIndex2, context) : index2],
					0,
				)
			...
			# Diff exists but close, can concatenate.
				...
				delta.addDiff1(
					self.content1[index1 - min(index1 - previousIndex1, distance) : index1],
					0,
				)
				delta.addDiff2(
					self.content2[index2 - min(index2 - previousIndex2, distance) : index2],
					0,
				)
