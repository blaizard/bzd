...
load("//private/filegroup_no_runfiles:filegroup_no_runfiles.bzl", _bzd_filegroup_no_runfiles = "bzd_filegroup_no_runfiles")
...
bzd_filegroup_no_runfiles = _bzd_filegroup_no_runfiles
