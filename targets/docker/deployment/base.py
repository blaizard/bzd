...
class Docker:
    def __init__(self, ast: Ast, symbol: str) -> None:
        ...
        self.expressions = {
            ...
            for fqn, entity in ast.registry.items()
            if entity.expression.symbol == symbol
        }

    def makeDockerCompose(
        self, fqn: str, expression: Parameters
    ) -> typing.Tuple[str, typing.Set[str]]:
        raise Exception("Unimplemented")

    def makeDockerComposeForAllInstances(
        self,
    ) -> typing.Tuple[typing.Dict[str, str], typing.Set[str]]:
        ...
        for fqn, expression in self.expressions.items():
            currentDockerCompose, currentImages = self.makeDockerCompose(
                fqn, expression
            )
    ...
    def getInterfaces(self, fqn: str, interface: str) -> typing.List[Parameters]:
        ...
        return [
            workload.expression.parameters
            for workload in self.ast.workloads
