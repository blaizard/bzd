...
public: // Accessors.
	...
	/// In other words, this represents the first contiguous portion of the data to be read.
	///
	...
	/// In other words, this represents the first contiguous portion of the free slots.
	///
	/// \return A span containing the contiguous memory region.
