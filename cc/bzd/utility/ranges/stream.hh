...
public:
	...
	/// A Stream cannot have a size, even though it could have one if it comes from a sized range.
	/// Deleting it ensures no wrong uses that would make it incompatible with the concept.
