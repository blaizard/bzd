...
TEST(ToString, Integer)
{
	...
	{
		const auto result = toString(str.assigner(), 12);
		EXPECT_TRUE(result);
	...
	{
		const auto result = toString(str.assigner(), -426);
		EXPECT_TRUE(result);
	...
	{
		const auto result = toString(str.assigner(), 0);
		EXPECT_TRUE(result);
	...
	{
		const auto result = toString(str.assigner(), static_cast<bzd::Int64>(1234567890));
		EXPECT_TRUE(result);
...
TEST(ToString, Float)
{
	...
	{
		const auto result = toString(str.assigner(), 12.45);
		EXPECT_TRUE(result);
	...
	{
		const auto result = toString(str.assigner(), 12.50049, 5);
		EXPECT_TRUE(result);
	...
	{
		const auto result = toString(str.assigner(), 12.50049, 4);
		EXPECT_TRUE(result);
	...
	{
		const auto result = toString(str.assigner(), 12.50049, 3);
		EXPECT_TRUE(result);
		EXPECT_EQ(result.value(), 4u);
	...
	{
		const auto result = toString(str.assigner(), 12.50049, 2);
		EXPECT_TRUE(result);
		EXPECT_EQ(result.value(), 4u);
		EXPECT_STREQ(str.data(), "12.5");
	}
	...
	{
		const auto result = toString(str.assigner(), 12.50049, 1);
		EXPECT_TRUE(result);
		EXPECT_EQ(result.value(), 4u);
		EXPECT_STREQ(str.data(), "12.5");
	}
	...
	{
		const auto result = toString(str.assigner(), 12.50049, 0);
		EXPECT_TRUE(result);
...
TEST(ToString, Overflow)
{
	{
		bzd::String<0> str;
		const auto result1 = toString(str.assigner(), 12);
		EXPECT_FALSE(result1);
		EXPECT_EQ(str.size(), 0U);
		const auto result2 = toString(str.assigner(), -12);
