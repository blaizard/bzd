...
class Cache(typing.Generic[T]):
    def __init__(
        self, function: typing.Callable[[], T], defaultValue: T, expireS: int
    ) -> None:
...
class Docker:
    def __init__(self, socket: typing.Optional[pathlib.Path]) -> None:
        ...
        self.diskSpace: Cache[DiskSpace] = Cache(
            self.getDiskSpace, defaultValue={}, expireS=3600 * 6
        )
    ...
    def getDiskSpace(self) -> DiskSpace:
        ...
        # This takes time.
        raw = self.request("GET", "/system/df?type=volume", timeoutS=600)
    ...
    def _memoryInfo(self, containerId: str, stats: typing.Any) -> typing.Any:
        ...
        try:
            memoryUsage = stats["memory_stats"]["usage"] - stats["memory_stats"][
                "stats"
            ].get("cache", 0)
    ...
    def _returnRate(self, previousData: typing.Any, data: typing.Any) -> typing.Any:
        ...
        for name, rate in data.items():
            if diffTimestampS < 0.01:
                ...
                dataWithRates[name] = {
                    "in": (
                        (rate["in"] - previousDataRates.get("in", rate["in"]))
                        / diffTimestampS
                    ),
                    "out": (
                        (rate["out"] - previousDataRates.get("out", rate["out"]))
                        / diffTimestampS
                    ),
                }
    ...
    def _ioInfo(self, containerId: str, stats: typing.Any) -> typing.Any:
        ...
        try:
            ...
            if stats["blkio_stats"]["io_service_bytes_recursive"]:
                ...
                return self._returnRate(
                    self.previousIO.setdefault(containerId, {}),
                    {"block": {"in": writeBytes, "out": readBytes}},
                )
    ...
    def _networkInfo(self, containerId: str, stats: typing.Any) -> typing.Any:
        ...
        try:
            ...
            return self._returnRate(
                self.previousNetwork.setdefault(containerId, {}), output
            )
    ...
    def getContainerStats(self, container: Container) -> typing.Any:
        ...
        raw = self.request(
            "GET", f"/containers/{containerId}/stats?stream=false", timeoutS=600
        )
        output = {
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--measure-time", type=float, default=None, help="Measure for x seconds."
    )
    parser.add_argument(
        "uid",
        nargs="?",
