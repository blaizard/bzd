...
class Generator:
	...
	def generate(self, startTime: typing.Optional[Date] = None, endTime: typing.Optional[Date] = None) -> RecordingFromData:
...
if __name__ == "__main__":
	...
	for index in range(len(tickerList)):
		...
		try:
			...
			recordingToPath(recording, pathlib.Path("~/recordings"))
