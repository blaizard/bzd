...
auto typoke(ConstexprStringView<X...>, ConstexprStringView<A>, ConstexprStringView<Y>...)
	-> decltype(typoke(ConstexprStringView<X..., A>(), ConstexprStringView<Y>()...));
...
// 2^5 = 32
#define CONSTEXPR_STRING_VIEW_32(n, x) CONSTEXPR_STRING_VIEW_16(n##0, x), CONSTEXPR_STRING_VIEW_16(n##1, x)
