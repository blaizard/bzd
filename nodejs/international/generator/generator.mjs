...
class Flags {
  ...
  async generate(config) {
	...
	console.log("Creating flags image in " + config.width + "x" + config.height + " for " + Object.keys(countries) +
				" to " + config.outputImage + "...");
	let index = 0;
	let countriesJs = {};
	let countriesCssList = [
	  "*[class^=\"bzd-flag-\"] {display:inline-block;content:'';vertical-align:middle;background:url(" +
		  ...
		  ") no-repeat left top;width:" + config.width + "px;height:" + config.height + "px;}",
	];
