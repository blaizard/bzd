...
export class HttpClientFactory {
  ...
  async request(endpoint, options = {}) {
	const baseOptions = typeof this.optionsOrCallback == "function" ? await this.optionsOrCallback(options.args)
																	: this.optionsOrCallback;
...
export class HttpClientException extends ExceptionFactory
("fetch", "impl") {
...
export default class HttpClient {
  static async request(url, options = {}) {
	...
	if (options.throwOnResponseError && (result.code < 200 || result.code > 299)) {
	  throw new HttpClientException(result.code, result.data, "Request to '{}' responded with: {}: {}", url,
