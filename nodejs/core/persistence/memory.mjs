...
export default class PersistenceMemory {
   ...
   */
  async _initialize() { return this.reset(); }
   ...
   */
  async waitReady() { return this.event.waitUntil("ready"); }
   ...
   */
  async savepoint() { Exception.assert(this.isReady, "Persistence is not ready yet."); }

  /**
   * This function is for testing only. It ensures that
   * the content is consistent.
   */
  async consistencyCheck() { return true; }
}
