export default class Permissions {
  ...
  encode() {
	return ((this.permissions.read ? "r" : "") + (this.permissions.write ? "w" : "") +
			(this.permissions.delete ? "d" : "") + (this.permissions.list ? "l" : "") +
			(this.permissions.executable ? "x" : ""));
  }

  isRead() { return this.permissions.read || false; }

  isWrite() { return this.permissions.write || false; }

  isDelete() { return this.permissions.delete || false; }

  isList() { return this.permissions.list || false; }

  isExecutable() { return this.permissions.executable || false; }
