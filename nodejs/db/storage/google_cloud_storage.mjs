...
export default class StorageGoogleCloudStorage extends Base {
  ...
  _getFile(pathList) { return this.bucket.file(this._getFullPath(pathList)); }
  ...
  async _readImpl(pathList) { return this._getFile(pathList).createReadStream(); }
  ...
  async _listImpl(pathList, maxOrPaging, includeMetadata) {
	...
	for (const file of files) {
	  ...
	  result.push(includeMetadata ? Permissions.makeEntry({
		name : name,
