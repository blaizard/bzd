...
def _load_esp32_xtensa_lx6_gcc_8_2_0(name):
    ...
    http_archive(
        ...
        build_file = "//toolchains/cc/esp32_xtensa_lx6_gcc:{}.BUILD".format(clang_package_name),
        urls = [
    ...
    http_archive(
        ...
        build_file = "//toolchains/cc/esp32_xtensa_lx6_gcc:{}.BUILD".format(sdk_package_name),
        urls = [
