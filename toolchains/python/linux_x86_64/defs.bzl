...
def load_linux_x86_64_python():
    debian_archive(
        ...
        urls = {
            ...
            "http://archive.ubuntu.com/ubuntu/pool/main/p/python3-stdlib-extensions/python3-lib2to3_3.6.5-3_all.deb": "da61799a4268583ec7ef6cda2230e6b9df27d4455783f9fa708900c4ca02179a",
        },
    )
