...
{
	static constexpr const int value = (FindConditional<N, Condition, T, U>::value >= 0) ? FindConditional<N, Condition, T, U>::value : FindConditional<N + 1, Condition, T, Ts...>::value;
};
