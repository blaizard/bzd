...
class Visitor(_VisitorCommon[T, U]):
    ...
    def _visit(self, sequence: Sequence, result: typing.Any = None) -> T:
        assert isinstance(sequence, Sequence), "Must be a sequence, instead: {}".format(
            type(sequence)
        )
    ...
    def visitNested(
        self, element: Element, nestedSequence: Sequence, result: typing.Any
    ) -> typing.Any:
...
class VisitorDepthFirst(_VisitorCommon[T, U]):
    ...
    def visitElement(
        self, element: Element, result: typing.Any, nestedResult: typing.Any
    ) -> typing.Any:
        return result
