...
CallbackType: typing.TypeAlias = typing.Union[
    typing.Callable[..., None], typing.Callable[..., bool]
]
...
class Scheduler:
    def __init__(self, blocking: bool = False) -> None:
        ...
        self.worker = threading.Thread(
            target=self._process, daemon=False if blocking else True
        )
    ...
    def add(
        ...
        assert not self.worker.is_alive(), (
            "Workload cannot be added while the scheduler is running."
        )
        workload = Workload(
            name=name,
            intervalS=intervalS,
