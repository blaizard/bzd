...
class TestSemver(unittest.TestCase):
    def testSemver(self) -> None:
        ...
        self.assertLess(
            Semver.fromString("1.0.0-alpha"), Semver.fromString("1.0.0-alpha.1")
        )
        self.assertLess(
            Semver.fromString("1.0.0-alpha.1"), Semver.fromString("1.0.0-beta.2")
        )
        self.assertLess(
            Semver.fromString("1.0.0-beta.2"), Semver.fromString("1.0.0-beta.11")
        )
        self.assertLess(
            Semver.fromString("1.0.0-beta.11"), Semver.fromString("1.0.0-rc.1")
        )
    ...
    def testSemverMatcherMultiple(self) -> None:
        ...
        self.assertTrue(
            SemverMatcher("1.1 || 1.2 || 3.4 || 1.5").match(Semver.fromString("3.4"))
        )
