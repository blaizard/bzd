...
class _Row:
    ...
    def get(
        self, identifier: typing.Union[int, str], strip: bool = True
    ) -> typing.Optional[str]:
        """
        ...
        """
        assert self.table.isValidIdentifier(identifier), (
...
class FixedTable:
    ...
    @staticmethod
    def fromHeader(
        header: str, schema: typing.Dict[str, typing.Any]
    ) -> typing.Optional["FixedTable"]:
        """
        ...
        for name in header.split():
            ...
            assert name not in nameToIndex, "Cell name already discovered: {}".format(
                name
            )
    ...
    @staticmethod
    def fromPattern(
        line: str, regexpr: typing.Pattern[str]
    ) -> typing.Optional["FixedTable"]:
        """
    ...
    def parse(self, line: str) -> _Row:
        ...
        parts = [
            line[i:j]
            for i, j in zip(self.separations, self.separations[1:] + [len(line)])
        ]
