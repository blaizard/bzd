...
class Constraint:
    ...
    def install(
        self, processedSchema: "ProcessedSchema", args: typing.List[str]
    ) -> None:
        """
    ...
    def _toFloat(value: str) -> float:
        ...
        try:
            ...
            raise Exception(
                "expects a floating point number, received: '{}'.".format(value)
            )
...
class ProcessedSchema:
    def __init__(self) -> None:
        ...
        self.validations: typing.List[
            typing.Callable[[Context], typing.Optional[str]]
        ] = []
    ...
    def setMandatory(self) -> None:
        ...
        """
        assert not self.mandatory_, "Mandatory constraint already set."
    ...
    def setType(self, constraint: Constraint) -> None:
        ...
        assert self.type is None, (
            f"A type for this constraint is already specified: {str(self.type)}"
        )
    ...
    def install(
        ...
        if self.type is not None and name in self.type.constraints:
            ...
            assert name in constraints, "Constraint of type '{}' is undefined.".format(
                name
            )
    ...
    def installValidation(
        self, validation: ValidationCallable, args: typing.Any
    ) -> None:
        """
