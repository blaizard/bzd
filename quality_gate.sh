...
./tools/bazel test --target_pattern_file=tools/ci/bazel_target_patterns.txt --output_groups=+metadata --config=esp32_qemu --config=prod --config=cc --platform_suffix=esp32-prod $EXTRA_FLAGS
...
./tools/bazel test --target_pattern_file=tools/ci/bazel_target_patterns.txt --output_groups=+metadata --config=esp32s3_qemu --config=prod --config=cc --platform_suffix=esp32s3-prod $EXTRA_FLAGS
