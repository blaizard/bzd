...
echo  "==== [stress] dev ==============================="
./tools/bazel test ... --build_tests_only --test_tag_filters=stress --config=linux_x86_64_clang --config=dev --runs_per_test=100 --platform_suffix=_linux_x86_64_clang_dev $EXTRA_FLAGS
echo  "==== [stress] prod ==============================="
./tools/bazel test ... --build_tests_only --test_tag_filters=stress --config=linux_x86_64_clang --config=prod --runs_per_test=100 --platform_suffix=_linux_x86_64_clang_prod $EXTRA_FLAGS
...
./tools/bazel coverage ... --config=py --config=linux_x86_64_clang --platform_suffix=_coverage_py && ./tools/bazel run tools/coverage -- --output bazel-out/coverage_py $EXTRA_FLAGS
echo  "==== [coverage] NodeJs ==============================="
./tools/bazel coverage ... --config=nodejs --config=linux_x86_64_clang --platform_suffix=_coverage_nodejs && ./tools/bazel run tools/coverage -- --output bazel-out/coverage_nodejs $EXTRA_FLAGS
