...
bazel test ... --output_groups=default,metadata --config=dev --platform_suffix=_dev $EXTRA_FLAGS
bazel test ... --output_groups=default,metadata --config=prod --platform_suffix=_prod $EXTRA_FLAGS
bazel test ... --output_groups=default,metadata --config=linux_x86_64_clang $EXTRA_FLAGS
bazel build ... --output_groups=default,metadata --config=esp32_xtensa_lx6_gcc $EXTRA_FLAGS
